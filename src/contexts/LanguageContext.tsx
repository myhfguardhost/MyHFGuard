...
const translations: Record<Language, Record<string, string>> = {
  BI: {
    ...
    lastWeekGoalReview: "Last Week's Rating",
    lastWeekGoalReviewDesc: "Review how well you achieved the exercise goal selected for last week.",
    lastWeekGoal: "Last week's goal",
    achievementQuestion: "How far have you achieved this goal in the last week?",
    ratingScaleHint: "Scale 1–5: 1 = Not achieved, 5 = Fully achieved",
    achievementRating: "Achievement rating",
    ratingOneLabel: "1 - Not achieved",
    ratingFiveLabel: "5 - Fully achieved",
    saveRating: "Save Rating",
    ratingSaved: "Your achievement rating has been saved.",
    ratingSubmitted: "Rating Submitted",
    ratingAlreadySubmitted: "You have already rated last week's goal.",
    selectRatingFirst: "Please choose a rating from 1 to 5.",
    ratingLoadFailed: "Unable to load last week's exercise goal.",
    ratingSaveFailed: "Unable to save the achievement rating. Please check your connection and Supabase permissions.",
    noPreviousGoal: "No goal was found for last week.",
    loadingLastWeekGoal: "Loading last week's goal...",
  ...
  BM: {
    ...
    lastWeekGoalReview: "Penilaian Minggu Lepas",
    lastWeekGoalReviewDesc: "Nilai sejauh mana anda mencapai matlamat senaman yang dipilih pada minggu lepas.",
    lastWeekGoal: "Matlamat minggu lepas",
    achievementQuestion: "Sejauh manakah anda telah mencapai matlamat ini pada minggu lepas?",
    ratingScaleHint: "Skala 1–5: 1 = Tidak dicapai, 5 = Dicapai sepenuhnya",
    achievementRating: "Penilaian pencapaian",
    ratingOneLabel: "1 - Tidak tercapai",
    ratingFiveLabel: "5 - Tercapai sepenuhnya",
    saveRating: "Simpan Penilaian",
    ratingSaved: "Penilaian pencapaian anda telah disimpan.",
    ratingSubmitted: "Penilaian Dihantar",
    ratingAlreadySubmitted: "Anda telah menilai matlamat minggu lepas.",
    selectRatingFirst: "Sila pilih penilaian daripada 1 hingga 5.",
    ratingLoadFailed: "Tidak dapat memuatkan matlamat senaman minggu lepas.",
    ratingSaveFailed: "Tidak dapat menyimpan penilaian pencapaian. Sila semak sambungan dan kebenaran Supabase.",
    noPreviousGoal: "Tiada matlamat ditemui untuk minggu lepas.",
    loadingLastWeekGoal: "Sedang memuatkan matlamat minggu lepas...",
